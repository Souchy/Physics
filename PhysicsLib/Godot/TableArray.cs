...
public class TableArray<T> : IEnumerable<(int x, int y, T v)>
{
	...
	private int Index(int x, int y) => x + Width * y;
	private int Index(Vector2I pos) => Index(pos.X, pos.Y);
	...
	public TableArray<T> GetNeighboors(int x, int y)
	{
